...
final class AppTest extends TestCase {
    ...
    public function testNonExistingAction()
    {
        ...
        $app = \Gaslawork\App::instance(
            (new Router)
                ->add(new Route("/:controller/:action", "\Gaslawork\Tests\{+controller}", "{action}Action"))
        );
    ...
    public function testFetchParams()
    {
        $app = \Gaslawork\App::instance(
            (new Router)
                ->add(new Route("/:controller/:action/:id1/:id2", "\Gaslawork\Tests\{+controller}", "{action}Action"))
        );
    ...
    public function testFetchParamFromController()
    {
        ...
        $app = \Gaslawork\App::instance(
            (new Router)
                ->add(new Route("/:controller/:action/:id", "\Gaslawork\Tests\{+controller}", "{action}Action"))
        );
    ...
    public function testFetchNonExisstingParamFromController()
    {
        ...
        $app = \Gaslawork\App::instance(
            (new Router)
                ->add(new Route("/:controller/:action/:no", "\Gaslawork\Tests\{+controller}", "{action}Action"))
        );
